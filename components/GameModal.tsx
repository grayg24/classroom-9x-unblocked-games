...
import { Maximize2, RotateCcw, Heart, Share2, Info, X, Loader2, Zap, Trophy } from 'lucide-react';
...
const GameModal: React.FC<GameModalProps> = ({ game, isFavorite, onToggleFavorite, onClose }) => {
  ...
  const handleRefresh = () => {
    const iframe = document.getElementById('game-iframe-modal') as HTMLIFrameElement;
